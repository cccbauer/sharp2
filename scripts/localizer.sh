...
then
    ...
    echo singularity exec murfi2.1.sif murfi -f $subj_dir/xml/2vol.xml
fi
...
clear
    ...
    then
        ...
        fslmerge -tr $rest_runA_filename $volsA 0.9
        fslmerge -tr $rest_runB_filename $volsB 0.9
